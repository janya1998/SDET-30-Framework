...
public class CreateOrgWithMulipleDataTest {
	//create obj for all utilites
...
public void CreateOrgWithMulipleData(String orgName,String indType) throws Throwable
{
	//read the data
...
{
	Object[][] data1=eLib.readmultipleDataFromExcel("orgMultipalData");
	return data1;
}
