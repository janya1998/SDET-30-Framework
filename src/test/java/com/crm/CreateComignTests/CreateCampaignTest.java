package com.crm.CreateComignTests;
...
public class CreateCampaignTest {
	...
	Cell ce = ro.getCell(2);
			...
			WebDriverWait wait=new WebDriverWait(driver, 20);
			 WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@src='themes/softed/images/menuDnArrow.gif']")));
			 element.click();
